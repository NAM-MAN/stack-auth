...
const waitForVerificationEmail =async (testEmail: string) => {
  const resendApiKey = getEnvVariable("STACK_RESEND_EMAIL_API_KEY");
...
export const GET = createSmartRouteHandler({
  ...
  handler: async () => {
    ...
    const testEmail = `monitor+${uniqueId}@${getEnvVariable("STACK_RESEND_EMAIL_DOMAIN")}`;
    const testPassword = "MonitorTestPassword123!";
